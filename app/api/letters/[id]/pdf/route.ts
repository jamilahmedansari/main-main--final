...
export async function GET(
  ...
  let footerText = 'This document has been reviewed and approved for professional formatting and clarity.<br><em>This is not legal advice.</em>';

    // If letter was reviewed, check if reviewer is an attorney
    if (letter.reviewed_by) {
      ...
      if (reviewer?.is_licensed_attorney) {
        footerText = 'This document has been reviewed by a licensed attorney.<br><em>This does not constitute an attorney-client relationship.</em>';
      }
    }
